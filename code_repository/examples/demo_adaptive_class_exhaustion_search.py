...
from kam_theorem_suite import (
    ArithmeticClassSpec,
    build_adaptive_class_exhaustion_search_report,
)
...
def main() -> None:
    ...
    path = outdir / "demo_adaptive_class_exhaustion_search.json"
