...
from kam_theorem_suite.proof_driver import build_multi_source_campaign_comparison_report
...
if __name__ == '__main__':
    ...
    print({
        'seeded_certified_crossing_count': rep['seeded_certified_crossing_count'],
        'atlas_certified_crossing_count': rep['atlas_certified_crossing_count'],
