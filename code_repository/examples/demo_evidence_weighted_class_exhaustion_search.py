...
from kam_theorem_suite import ArithmeticClassSpec, build_evidence_weighted_class_exhaustion_search_report
...
def main() -> None:
    ...
    report = build_evidence_weighted_class_exhaustion_search_report(
        specs,
    ...
    path = outdir / 'demo_evidence_weighted_class_exhaustion_search.json'
