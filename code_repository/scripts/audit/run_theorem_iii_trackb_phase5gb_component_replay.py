...
def main() -> None:
    p = argparse.ArgumentParser(description="Replay Phase 5G-b sign/hash-corrected component attachment candidate.")
    ...
    summarize_phase5g(
        ...
        f"{args.out_dir}/phase5gb_replay_compact_report.json",
    )
    print(f"[phase5gb] replay={args.out_dir}/phase5g_component_replay_summary.json")
    print(f"[phase5gb] compact={args.out_dir}/phase5gb_replay_compact_report.json")
